...
<head>
    ...
    <title>Register - Anaphygon Retro</title>
            ...
            <div class="col-md-6">
                <div class="auth-container">
                    ...
                    <form action="" method="post">
                        ...
                        <div class="form-floating mb-3">
                            <input class="form-control" type="password" name="password2" id="password2" placeholder="Konfirmasi Password" required>
                            <label for="password2">Konfirmasi Password</label>
                        </div>
                        
                        <div class="d-grid gap-2 mb-3">
                            <button type="submit" name="register" class="btn btn-retro btn-lg">Register</button>
                        </div>
                        
                        <div class="text-center">
                            <p>Sudah memiliki akun? <a href="login.php" class="text-decoration-none" style="color: var(--retro-orange); font-weight: bold;">Login Disini</a></p>
                        </div>
                    </form>
                </div>
            </div>
